...
async function requestImpactSummary(
  ...
  let fallbackSummary: ImpactAgentSummary | null = null;
  ...
  for (let attempt = 0; attempt < liveAgentRequestAttempts; attempt += 1) {
    ...
    const summary = normaliseImpactSummary(
      (await response.json()) as Partial<ImpactAgentSummary>,
    );

    if (summary.source === "openrouter") {
      return summary;
    }
  ...
  return fallbackSummary ?? impactAgentSummary;
}
    ...
    requestImpactSummary(acceptedRouteMatch, currentImpact)
      ...
      .catch(() => {
        onImpactSummaryResolved(batchId, {
          ...impactAgentSummary,
          caveat: `${impactAgentSummary.caveat} Fallback demo data prepared this summary because a FoodLoop AI recommendation was unavailable.`,
          source: "fallback",
  ...
  return (
    <section className="page-stack impact-page" aria-labelledby="impact-title">
      <div className="page-heading impact-heading">
        <div>
          <p className="page-kicker">FoodLoop impact summary</p>
          ...
          <div className="impact-agent-caveat">
            ...
            <p>
              ...
              {activeImpactSummary.source === "openrouter" && activeImpactSummary.model
                ? ` Generated as a FoodLoop AI recommendation (model: ${activeImpactSummary.model}).`
                : ""}
            </p>
          </div>
